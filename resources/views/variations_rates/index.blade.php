...
<table class="table table-striped table-hover table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <a href="{{ route('variations_rates.edit', $complicationRate->id) }}" class="btn btn-sm btn-primary me-2">Edit</a>
                    <form action="{{ route('variations_rates.destroy', $complicationRate->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
